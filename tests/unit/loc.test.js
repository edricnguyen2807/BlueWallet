...
describe('Localization', () => {
  ...
  it('formatBalancePlain() && formatBalancePlain()', () => {
    ...
    let newInputValue = formatBalanceWithoutSuffix(152, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.ok(newInputValue === 'RUB 1.00' || newInputValue === '1,00 ₽', 'Unexpected: ' + newInputValue);
    newInputValue = formatBalancePlain(152, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.strictEqual(newInputValue, '1');

    newInputValue = formatBalanceWithoutSuffix(1515, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.ok(newInputValue === 'RUB 10.00' || newInputValue === '10,00 ₽', 'Unexpected: ' + newInputValue);
    newInputValue = formatBalancePlain(1515, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.strictEqual(newInputValue, '10');

    newInputValue = formatBalanceWithoutSuffix(16793829, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.ok(newInputValue === 'RUB 110,869.52' || newInputValue === '110 869,52 ₽', 'Unexpected: ' + newInputValue);
    newInputValue = formatBalancePlain(16793829, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.strictEqual(newInputValue, '110869.52');

    newInputValue = formatBalancePlain(76, BigcoinUnit.LOCAL_CURRENCY, false);
    ...
    newInputValue = formatBalancePlain(16000000, BigcoinUnit.LOCAL_CURRENCY, false);
    assert.strictEqual(newInputValue, '1600');
  });

  it.each([
    [123000000, BigcoinUnit.SATS, false, '123000000', false],
    [123000000, BigcoinUnit.SATS, true, '123,000,000', false],
    [123456000, BigcoinUnit.BBTC, true, '1.23456', false],
    ['123456000', BigcoinUnit.BBTC, true, '1.23456', false], // can handle strings
    [100000000, BigcoinUnit.BBTC, true, '1', false],
    [10000000, BigcoinUnit.BBTC, true, '0.1', false],
    [1, BigcoinUnit.BBTC, true, '0.00000001', false],
    [10000000, BigcoinUnit.LOCAL_CURRENCY, true, '...', true], // means unknown since we did not receive exchange rate
  ])(
  ...
  it.each([
    [123000000, BigcoinUnit.SATS, false, '123000000 sats'],
    [123000000, BigcoinUnit.BBTC, false, '1.23 BTC'],
    [123000000, BigcoinUnit.LOCAL_CURRENCY, false, '$1.23'],
  ])(
    'can formatBalance',
